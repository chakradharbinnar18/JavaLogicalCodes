...
public class FindEmpHavingSecondHighestSalary {
	...
	public static void main(String[] args) {
		...
		Employee emp= listEmp.stream().sorted(Comparator.comparing(Employee::getSalary).reversed()).distinct().skip(1).findFirst().get();
