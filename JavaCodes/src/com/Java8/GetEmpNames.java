...
public class GetEmpNames {
	...
	public static void main(String[] args) {
		...
		listEmp.stream().forEach(e->System.out.println(e.getName()));
		
		//or
		List<String> empNameList=listEmp.stream().map(Employee::getName).collect(Collectors.toList());
